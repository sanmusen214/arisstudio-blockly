...
// 定义JSON格式自定义模块
let blockname="b_pic_shakexy"
// 带有映射的学生名
const jsondesc = {
    "type": `${blockname}`,
    "message0": "图片昵称 %1 随机方向 抖动%2秒，幅度 %3 频率 %4",
    "args0": [
      {
        "type": "input_value",
        "name": "val1",
...
javascriptGenerator[blockname] = function (block) {
    ...
    return `stagelist.push(\`${myImager.shakerandom(wrapStr(nickname),distance,spendtime,frequency)}\`);`
}
